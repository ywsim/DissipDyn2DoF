...
H = zeros(5,5);
  ...
  H(3,5)=I(3) + (L(3)^2*m(3))/4 + gear(2)*gear(4)*(1/eff(2))^(1/2) + (L(2)*L(3)*m(3)*cos(q(5)))/2;
  ...
  H(4,5)=I(3) + (L(3)^2*m(3))/4 + (gear(2)*gear(4)^2)/eff(2) + gear(2)*gear(4)*(1/eff(2))^(1/2) +...
          (L(2)*L(3)*m(3)*cos(q(5)))/2;
  H(5,1)=-(L(3)*m(3)*sin(q(3) + q(4) + q(5)))/2;
  H(5,2)=(L(3)*m(3)*cos(q(3) + q(4) + q(5)))/2;
  H(5,3)=I(3) + (L(3)^2*m(3))/4 + gear(2)*gear(4)*(1/eff(2))^(1/2) + (L(2)*L(3)*m(3)*cos(q(5)))/2;
  H(5,4)=I(3) + (L(3)^2*m(3))/4 + (gear(2)*gear(4)^2)/eff(2) + gear(2)*gear(4)*(1/eff(2))^(1/2) +...
          (L(2)*L(3)*m(3)*cos(q(5)))/2;
  H(5,5)=I(3) + (L(3)^2*m(3))/4 + (gear(2)*gear(4)^2)/eff(2);
